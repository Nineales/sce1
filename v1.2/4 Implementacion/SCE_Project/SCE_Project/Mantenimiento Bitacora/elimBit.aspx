<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="elimBit.aspx.cs" Inherits="SCE_Project.Mantenimienro_Bitacora.elimBit" %>
...
<body>
    ...
    <asp:Label ID="etNom" runat="server" Text="Nombre del chofer: "></asp:Label>
        ...
        <asp:TextBox ID="txFechaFin" runat="server" TextMode="Date" ValidateRequestMode="Enabled"></asp:TextBox>
