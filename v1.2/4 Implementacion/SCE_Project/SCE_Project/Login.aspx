...
<body id="bodylog">
    ...
    <form id="formlogin" runat="server" >
            ...
            <asp:Login ID="Login1" runat="server" OnAuthenticate="Login1_Authenticate" FailureText="Error al iniciar sesión, intente de nuevo con un id de usuario y/ó un password correcto." ForeColor="Black" DisplayRememberMe="False" PasswordRequiredErrorMessage="Favor de insertar el password" UserNameRequiredErrorMessage="Favor de insertar un Id de usuario" ValidateRequestMode="Enabled" ViewStateMode="Enabled">
